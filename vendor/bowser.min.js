  ...
  function t(t) {
    ...
    /opera|opr/i.test(t)
      ...
      ? ((f = {
        ...
        /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(t) && (f.firefoxos = e))
      : /silk/i.test(t)
      ? (f = {
          name: "Amazon Silk",
          silk: e,
      ...
      : (f = {}),
      /(apple)?webkit/i.test(t)
        ? ((f.name = f.name || "Webkit"),
          (f.webkit = e),
          !f.version && o && (f.version = o))
        : !f.opera &&
          /gecko\//i.test(t) &&
          ((f.name = f.name || "Gecko"),
          (f.gecko = e),
    ...
    return (
      (f.msie && f.version >= 10) ||
      (f.chrome && f.version >= 20) ||
      (f.firefox && f.version >= 20) ||
      (f.safari && f.version >= 6) ||
      (f.opera && f.version >= 10) ||
      (f.ios && f.osversion && f.osversion.split(".")[0] >= 6) ||
      (f.blackberry && f.version >= 10.1)
        ? (f.a = e)
        : (f.msie && f.version < 10) ||
          (f.chrome && f.version < 20) ||
          (f.firefox && f.version < 20) ||
